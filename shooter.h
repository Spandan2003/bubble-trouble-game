...
public:
    Shooter(double position_x, double position_y, double vx_=100, double height=30, double width=18, double head_radius=8, Color color_=COLOR(153, 204, 255))
    {
        // Shooter constructor
        color = color_;
    ...
    {   //change color of shooter to blue
        body.setColor(COLOR(153, 204, 255));
        head.setColor(COLOR(153, 204, 255));
    }

    void change_color_green()
    {   //change color of shooter to green
